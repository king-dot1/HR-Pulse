      ...
      >
        ...
        <el-form ref="formRef" size="small" :model="formModel" :rules="rules" width="20%" label-width="120px">
          <el-form-item label="旧密码" prop="oldPassword">
            <el-input v-model="formModel.oldPassword" show-password placeholder="请输入旧密码" type="password" />
          </el-form-item>
          <el-form-item label="新密码" prop="newPassword">
            <el-input v-model="formModel.newPassword" show-password placeholder="请输入新密码" type="password" />
          </el-form-item>
          <el-form-item label="重复密码" prop="confirmPassword">
            <el-input v-model="formModel.confirmPassword" show-password placeholder="请再次输入密码" type="password" />
          </el-form-item>
          <el-form-item>
